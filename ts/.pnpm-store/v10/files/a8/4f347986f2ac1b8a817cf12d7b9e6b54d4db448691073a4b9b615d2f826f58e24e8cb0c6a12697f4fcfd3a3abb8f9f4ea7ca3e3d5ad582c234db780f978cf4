...
exports.fromApi = exports.annotations = exports.Version = exports.Transform = exports.Title = exports.Summary = exports.Servers = exports.Override = exports.License = exports.Identifier = exports.Format = exports.ExternalDocs = exports.Description = exports.Deprecated = void 0;
